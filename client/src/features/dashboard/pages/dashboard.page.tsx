    ...
    return [
      {
        ...
        popover: {
          ...
          description: 'Это ваша уникальная ссылка для записи. Поделитесь ею с клиентами, чтобы они могли записаться на приём. Вы можете скопировать её, кликнув на поле или кнопку.',
