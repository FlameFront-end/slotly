...
import { UpdateScheduleDto, ScheduleDayDto } from './dto/update-schedule.dto';
...
export class ScheduleService {
  ...
  async updateSchedule(
    ...
    // Валидация времени
    this.validateSchedule(updateDto.days);
  ...
  private validateSchedule(days: ScheduleDayDto[]): void {
